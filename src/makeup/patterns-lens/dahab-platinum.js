// src/eyewear/patterns-lens/dahab-platinum.js

import { lerp, shadeColor, PERLIN_PERMUTATION } from "./utils";

function createDahabPlatinumNoise2D() {
...
export function drawDahabPlatinumLens(
  canvasCtx,
  centerX,
  centerY,
  radius,
  ...
  const noise2D = createDahabPlatinumNoise2D();
  const scale = 0.05;
  ...
  addDahabPlatinumDetails(canvasCtx, centerX, centerY, radius);
}

function addDahabPlatinumDetails(canvasCtx, centerX, centerY, radius) {
